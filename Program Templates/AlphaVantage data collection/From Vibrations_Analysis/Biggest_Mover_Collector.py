...
# Using https://www.geeksforgeeks.org/reading-selected-webpage-content-using-python-web-scraping/ for reference
import requests 
...
def write_to_file():
    ...
    with open('0_biggest_movers_archive.txt', 'a') as f:
        f.write(symbol_string + '\n')

while True:        
    date = input('Date (MM.DD.YY): ')
    gain_url = input('Gain url: ')
    lose_url = input('Lose url: ')
